...
public class HttpRequestAspect {
    ...
    /*切点表达式*/
    @Pointcut("execution(public * com.boot.design.controller.*.*(..))")
    /*切点签名*/
    public void print() {
    ...
    public void before(JoinPoint joinPoint) {
        ...
        request.setAttribute("msg","我是都是好孩子!");
        ...
        Object[] args = joinPoint.getArgs();//获取切入点方法参数类型
